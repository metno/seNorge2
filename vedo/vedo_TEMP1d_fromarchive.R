...
#==============================================================================
arch.path<-"/lustre/storeB/users/cristianl"
# read command line
...
# input directories
path2input.1d.main<-paste(arch.path,"/seNorge2/TEMP1d",sep="")
...
path2input.1d.add<-paste(arch.path,"/seNorge2_addInfo/TEMP1d",sep="")
