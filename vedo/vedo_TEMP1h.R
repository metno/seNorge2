...
path2input.1d.add<-paste(main.path.output,"/seNorge2_addInfo/TEMP1h",sep="")
...
in.1d.file.grd.idi<- paste(path2input.1d.add.grd,"/",yyyymm,
                           "/seNorge_v2_0_TEMP1h_grid_idi_",
                           yyyymmddhh,".nc",sep="")
# output directories
dir.create(file.path(main.path.output,"seNorge2_scratch"), showWarnings = FALSE)
path2output.main<-paste(main.path.output,"/seNorge2_scratch/TEMP1h",sep="")
path2output.main.grd<-paste(path2output.main,"/TEMP",sep="")
path2output.add<-paste(main.path.output,"/seNorge2_scratch/TEMP1h",sep="")
