...
# | seNorge2->PREC3hRT->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC3hRT_grid_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +analysis/prediction at station locations
# | seNorge2->PREC3hRT->station_dataset->yyyymm
# | seNorge_v2_0_PREC3hRT_station_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +IDI Integral Data Influence
# | seNorge2_addInfo->PREC3hRT->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC3hRT_grid_normIDI_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +additional informations on events
# | seNorge2_addInfo->PREC3hRT->event_dataset->yyyymm
# | seNorge_v2_0_PREC3hRT_event_"yyyymmddhh.b"_"yyyymmddhh.e".txt
#
...
if (testmode) {
  ...
  if (file.exists(paste(main.path,"/Bspat_PREC3hRT/testbed",sep=""))) {
    testbed<-paste(main.path,"/Bspat_PREC3hRT/testbed",sep="")
...
path2output.main<-paste(main.path.output,"/seNorge2/PREC3hRT",sep="")
...
path2output.add<-paste(main.path.output,"/seNorge2_addInfo/PREC3hRT",sep="")
...
path2thredds.main<-paste(main.path.thredds,"/seNorge2/provisional_archive/PREC3hRT",sep="")
