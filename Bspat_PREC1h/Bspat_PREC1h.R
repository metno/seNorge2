...
# | seNorge2->PREC1h->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC1h_grid_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +analysis/prediction at station locations
# | seNorge2->PREC1h->station_dataset->yyyymm
# | seNorge_v2_0_PREC1h_station_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +IDI Integral Data Influence
# | seNorge2_addInfo->PREC1h->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC1h_grid_normIDI_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +additional informations on events
# | seNorge2_addInfo->PREC1h->event_dataset->yyyymm
# | seNorge_v2_0_PREC1h_event_"yyyymmddhh.b"_"yyyymmddhh.e".txt
#
...
# 26.02.2015 - Cristian Lussana. original code from Bspat_PREC1h_v1_0.R
#  change log: 
...
#  - output variable names: PREC1h, IDIms
...
# ellipsoid hulls computation could fail (i.e. small events) and return NAs. 
  # debug: start
#  png(file="../../seNorge2_scratch/Bspat_PREC1h/elli.png",width=1200,height=1200)
