...
# | seNorge2->PREC1hRT->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC1hRT_grid_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +analysis/prediction at station locations
# | seNorge2->PREC1hRT->station_dataset->yyyymm
# | seNorge_v2_0_PREC1hRT_station_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +IDI Integral Data Influence
# | seNorge2_addInfo->PREC1hRT->gridded_dataset->yyyymm
# | seNorge_v2_0_PREC1hRT_grid_normIDI_"yyyymmddhh.b"_"yyyymmddhh.e".txt
# +additional informations on events
# | seNorge2_addInfo->PREC1hRT->event_dataset->yyyymm
# | seNorge_v2_0_PREC1hRT_event_"yyyymmddhh.b"_"yyyymmddhh.e".txt
#
...
if (testmode) {
  ...
  if (file.exists(paste(main.path,"/Bspat_PREC1hRT/testbed",sep=""))) {
    testbed<-paste(main.path,"/Bspat_PREC1hRT/testbed",sep="")
...
path2output.main<-paste(main.path.output,"/seNorge2/PREC1hRT",sep="")
...
path2output.add<-paste(main.path.output,"/seNorge2_addInfo/PREC1hRT",sep="")
...
path2thredds.main<-paste(main.path.thredds,"/seNorge2/provisional_archive/PREC1hRT",sep="")
...
out.file.grd.idi<- paste(path2output.add.grd,"/",yyyymm.b,
                         "/seNorge_v2_0_PREC1hRT_grid_normIDI_",
                         yyyymmddhh.b,"_",yyyymmddhh.e,".nc",sep="")
#
print("Output files:")
...
print(out.file.eve)
# Setup thredds files 
dir.create(paste(path2thredds.main.stn,"/",yyyymm.b,sep=""),showWarnings=F)
dir.create(paste(path2thredds.main.grd,"/",yyyymm.b,sep=""),showWarnings=F)
thr.file.stn<- paste(path2thredds.main.stn,"/",yyyymm.b,
                     "/seNorge_v2_0_PREC1hRT_station_",
                     yyyymmddhh.b,"_",yyyymmddhh.e,".txt",sep="")
thr.file.grd.ana<- paste(path2thredds.main.grd,"/",yyyymm.b,
                         "/seNorge_v2_0_PREC1hRT_grid_",
                         yyyymmddhh.b,"_",yyyymmddhh.e,".nc",sep="")
print("thredds files:")
print("analysis on the grid (netcdf)")
...
#@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    cat(paste(yyyy.b,mm.b,dd.b,hh.b,nhour,
              ...
              rep(NA,n.stn.output), #yidiv.eve
              formatC(ydqc.flag[stn.output],format="f",digits=0),
              "\n",sep=";"),file=thr.file.stn,append=T)
    # Figures
